...
<body>
	<div class="main_wrap">
		<div class="header">
			<h1 class="title"> <a href="./"> <img alt="DOKTORI" src="./Images/doktori.png" style="width: 300px;"></a> </h1>
			<ul class="log_list">
				<%
				if (session.getAttribute("UserId") == null || session.getAttribute("UserId").equals("guest")||session.getAttribute("UserId").equals("")) {
				%>
